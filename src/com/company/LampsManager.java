...
public class LampsManager {
    ...
    //region Util Methods
    private int getIndexByIdLamp(int id) throws Exception{
    ...
    public void addLamp(int powerLamp, int colourTemperature, String base, String brandName, Lamp.Type type, Lamp.Color color){
        id++;
        Lamp lamp = new Lamp( id, powerLamp, colourTemperature, base, brandName, type, color);
    ...
    public void deleteLamp(int id) throws Exception{
